...
export function generateLocalPass(passenger) {
  ...
  let PassID = passenger.classType.charAt(0).toUpperCase().concat(passenger.from.slice(0,3).toUpperCase()).concat(passenger.to.slice(0,3).toUpperCase());
  let Name = passenger.name.toUpperCase();
  let From = passenger.from.charAt(0).toUpperCase().concat(passenger.from.slice(1).toLowerCase());
  let To = passenger.to.charAt(0).toUpperCase().concat(passenger.to.slice(1).toLowerCase());
