...
export function calculateAutoFare(distance, waitingMinutes = 0) {
  ...
  if(typeof distance !== "number" || distance <= 0 || Number.isNaN(distance) || typeof waitingMinutes !== "number" || waitingMinutes < 0 || Number.isNaN(waitingMinutes)){
    return -1;
  }
